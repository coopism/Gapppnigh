...
async function seed() {
  ...
  // Create sample published deals for all hotels
  const sampleDeals = [
    // Crown City Suites - King Room (multiple dates)
    {
      id: uuidv4(),
      hotelId: hotel1Id,
      roomTypeId: room1Id,
    ...
    // Crown City Suites - Executive Suite
    {
      id: uuidv4(),
      hotelId: hotel1Id,
      roomTypeId: room2Id,
    ...
    // Crown Riverfront - River View King
    {
      id: uuidv4(),
      hotelId: hotel2Id,
      roomTypeId: room3Id,
    ...
    // Crown Riverfront - Penthouse Suite
    {
      id: uuidv4(),
      hotelId: hotel2Id,
      roomTypeId: room4Id,
    ...
    // Bayview Boutique - Standard Queen
    {
      id: uuidv4(),
      hotelId: hotel3Id,
      roomTypeId: room5Id,
    ...
    // Bayview Coastal - Ocean View Room
    {
      id: uuidv4(),
      hotelId: hotel4Id,
      roomTypeId: room7Id,
    ...
    // Bayview Coastal - Beachfront Suite
    {
      id: uuidv4(),
      hotelId: hotel4Id,
      roomTypeId: room8Id,
  ...
  // Create consumer-facing deals (the deals table)
  ...
  console.log("Created consumer-facing deals");
