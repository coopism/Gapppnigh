...
import { Star, MapPin, Bed, Heart, Wifi, Dumbbell, Car, UtensilsCrossed, Waves, Sparkles, Navigation, CalendarDays, Wine, Umbrella, Bell, ConciergeBell, LogIn, UserPlus } from "lucide-react";
    ...
    <>
      ...
      <Dialog open={showLoginDialog} onOpenChange={setShowLoginDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Sign in to save deals</DialogTitle>
            <DialogDescription>
              Create an account or sign in to save your favorite deals and access them anytime.
            </DialogDescription>
          </DialogHeader>
