  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative pt-16 pb-20 md:pt-24 md:pb-32 flex flex-col items-center px-4">
          <div className="w-full max-w-5xl mx-auto px-4 md:px-8">
            <BlurFade duration={0.7}>
              {/* Definition card */}
              <div className="clay-panel p-8 md:p-20 lg:py-28 lg:px-24">
                <FadeIn direction="none" duration={0.6} delay={0.1}>
                  <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-3 md:mb-4" style={{ color: "var(--clay-text)" }}>
                    Gap Night
                  </h1>
                  <div className="flex items-center gap-2 md:gap-3 mb-6 md:mb-8">
                    <span className="text-base md:text-lg lg:text-xl italic" style={{ color: "var(--clay-text-muted)" }}>
                      /ˈgæp nīt/ &nbsp; gæp nāɪt
                    </span>
                    <span className="text-xs md:text-sm font-semibold px-2.5 md:px-3 py-0.5 md:py-1 rounded-full"
                ...
                <FadeIn delay={0.3} duration={0.6}>
                  <p className="text-lg md:text-2xl lg:text-3xl leading-relaxed mb-3 md:mb-4" style={{ color: "var(--clay-text)" }}>
                    An unsold night between bookings — offered at a discount so it doesn't go to waste.
                  </p>
                  <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8" style={{ color: "var(--clay-text-muted)" }}>
